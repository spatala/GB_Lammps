...
def five_param_symm_props(mis_quat_fz, lat_pt_grp, x_tol=1e-04):
    """
    ...
    * Based on the location of the mis_quat_fz in the quaternion hypersphere (4-D), the point group symmetry of the
    ...
    """
    q0 = mis_quat_fz[0]; q1 = mis_quat_fz[1]; q2 = mis_quat_fz[2]; q3 = mis_quat_fz[3]

    if lat_pt_grp == 'O_h':
        k = math.sqrt(2)-1; k1=1.0/math.sqrt(1 + 2*k*k)
...
# print five_param_symm_props(np.array([0.9487, 0.3162, 0, 0]), 'O_h', 1e-04)